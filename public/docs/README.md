...
## 最近更新
- 2026-04-09：例行维护扫描 — 确认 **Compose 最新稳定 BOM 仍为 2026.03.01**（Compose 1.10.5，March 11, 2026），**Beta 为 1.11.0-beta02**（March 25, 2026）。Compose 1.11 正式版尚待发布。**更新 [Kotlin 2.x & Compose 性能优化](./kotlin2.md)**：新增 **Bug Fix 章节**（compose-runtime 1.11.0-beta02，2026-03-25），记录 `PausableComposition` 内部状态竞态条件修复——在快速滚动与配置变更并发时可能导致组合结果不一致或偶发 `IllegalStateException`，影响 Kotlin 2.3.20+ 且启用 Pausable Composition 的应用，建议升级至 1.11.0-beta02 或更高版本。所有本次扫描涉及的新特性（RemoteCompose alpha07、Material3 1.5.0-alpha16、Room3 alpha02 等）均已在现有文档中覆盖，无需额外修改。
