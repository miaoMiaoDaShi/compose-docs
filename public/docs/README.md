...
## 最近更新
- 2026-04-10：例行维护扫描 — 确认 **Compose 最新稳定 BOM 仍为 2026.03.01**（Compose 1.10.5，March 11, 2026），**Beta 为 1.11.0-beta02**（March 25, 2026）。Compose 1.11 正式版尚待发布。扫描 JetBrains Kotlin 博客（Kotlin 2.3.20 已于 3 月 16 日发布，Pausable Composition 默认启用）、Android Developers 博客（4 月初以 Android Studio / Gemma 4 AI 相关资讯为主，无 Compose 新版本公告）及 Compose Multiplatform 最新动态，确认所有知识点均已在现有文档中覆盖。本次扫描无新增文档需求。
